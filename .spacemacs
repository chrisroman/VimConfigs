...
`dotspacemacs/user-config' first."
  ...
  (defvar *haba-theme-dark* 'monokai)
  (defvar *haba-theme-light* 'dichromacy)
  ...
  ;; Don't expand "simpl" in Coq to weird stuff when pressing ESC
  (setq evil-want-abbrev-expand-on-insert-exit nil)

  (set-fontset-font t 'unicode (font-spec :name "Source Code Pro") nil 'prepend)
  )
